    ...
    <v-navigation-drawer
      ...
      >
        ...
        <v-list density="compact" nav>
          ...
          <v-list-item prepend-icon="mdi-briefcase" title="Jobs Posted" value="jobs-posted"></v-list-item>
          <v-list-item prepend-icon="mdi-file-document-outline" title="Applicants" value="applications"></v-list-item>
